        ...
        <div class="row">
          <div class="col-lg-8 mb-5" >
            <form action="#" method="post">
              ...
              <div class="form-group row">
                <div class="col-md-12">
                  <input type="text" class="form-control" placeholder="Jumlah Orderan">
                </div>
              </div>
              ...
              <div class="form-group row">
                <div class="col-md-10 mr-auto">
                  <input type="submit" class="btn btn-block btn-primary text-white py-3 px-5" value="ORDER NOW">
                  <!-- <div class="col-md-8"><a href="{{url('keranjang')}}" class="btn btn-success float-center">BUY</a></div> -->
                </div>
              </div>
            </form>
          </div>
