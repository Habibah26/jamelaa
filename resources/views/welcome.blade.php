  ...
  <body data-spy="scroll" data-target=".site-navbar-target" data-offset="300">
      ...
      <div class="container">
        <div class="row align-items-center text-center justify-content-center">
          <div class="col-lg-10">
            ...
            <p class="lead">PESAN BANYAK ENGGAK BIKIN RUGI !!!!</p>
            </div>
        </div>
      </div>
    </div>
    ...
    <div class="site-section bg-primary">
      <div class="container mb-5">
        <div class="row">
          <div class="col-md-7">
            <h2 class="text-white font-weight-bold">Best Seller !!!</h2>
            <p class="text-white lead">Berdasarkan penjualan perbulan.</p>
          </div>
        </div>
      </div>
      <div class="container-fluid">
        ...
        <div class="media-29191">
            ...
            <div class="d-flex vcard-91123 align-items-center">
              <div class="img mr-3"><img src="img/photo.JPG" alt="Image" class="img-fluid"></div>
              <div class="name">
                <span class="d-block">by Sembebf</span>
